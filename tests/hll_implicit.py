...
def main():
    ...
    assert sol.get_num_iterations() == approx(56, abs=5)
    assert bdy.get_lift_coef() == approx(0.3565, abs=5e-3)
    assert bdy.get_drag_coef() == approx(0.0015, abs=5e-4)
    assert bdy.get_pitch_coef() == approx(-0.0040, abs=5e-4)
